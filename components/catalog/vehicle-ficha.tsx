  ...
  return (
    <main className="pb-32 pt-24">
      <Container>
        ...
        <div ref={heroRef} className="mt-8 grid gap-10 lg:grid-cols-[3fr_2fr]">
        ...
        <div ref={specRef} className="mt-16 border-y border-border py-10">
        ...
        <section ref={costRef} className="mt-16">
